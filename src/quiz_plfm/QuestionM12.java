 ...
 * @author Admin
 */
public class QuestionM12 extends javax.swing.JFrame {
int answerd = 0;
int marks = 0;
    /**
     * Creates new form Platform
     */
    public QuestionM12(int answerd, int marks) {
        initComponents();
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
      ...
      new QuestionM13(answerd,marks).setVisible(true);
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuestionM12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestionM12(0,0).setVisible(true);
            }
        });
    }
